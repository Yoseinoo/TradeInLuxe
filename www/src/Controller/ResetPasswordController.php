...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash(
                'danger',
                'Oops...|Un problème est survenu lors de la validation de votre demande de réinitialisation de mot de passe - Le lien de réinitialisation du mot de passe n\'est pas valide. Veuillez réessayer de réinitialiser votre mot de passe.|error'
            );
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash(
                'success',
                'Succès !|Votre mot de passe a bien été réinitialisé.|success'
            );
