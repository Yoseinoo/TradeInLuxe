...
class DataFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $categories = [
            'Chaussures' => 'Découvrez notre collection exclusive de chaussures de luxe, où élégance et sophistication se rencontrent. Nous proposons une gamme variée comprenant des bottes, des ballerines, des chaussures à talon, des mocassins, des chaussures oxford, des sandales et des claquettes, toutes soigneusement sélectionnées pour répondre aux exigences des plus fins connaisseurs. Nos chaussures sont signées par les maisons de haute couture les plus prestigieuses, telles que Gucci, Louis Vuitton, Chanel, Hermès, et Yves Saint Laurent. Chaque paire incarne l\'essence du luxe et de l\'innovation, alliant savoir-faire artisanal et matériaux de qualité supérieure.',
            'Sacs' => 'Découvrez notre collection exclusive de sacs de luxe, où raffinement et élégance se rencontrent pour sublimer votre style. Nous offrons une gamme variée de sacs comprenant des sacs à main, des sacs à bandoulière, des pochettes, des sacs à dos et des cabas, tous sélectionnés avec soin pour satisfaire les attentes des amateurs de mode les plus exigeants. Nos sacs sont signés par les maisons de haute couture les plus prestigieuses telles que Gucci, Louis Vuitton, Chanel, Hermès, et Yves Saint Laurent. Chaque création incarne l\'essence du luxe et de l\'innovation, alliant savoir-faire artisanal et matériaux de la plus haute qualité.',
            'Vêtements' => 'Découvrez notre collection exclusive de vêtements de luxe, où élégance et sophistication se rencontrent pour sublimer votre garde-robe. Nous proposons une gamme variée comprenant des robes, des costumes, des chemises, des pantalons, des vestes, des manteaux, des jupes et des pulls, tous soigneusement sélectionnés pour répondre aux exigences des plus fins connaisseurs. Nos vêtements sont signés par les maisons de haute couture les plus prestigieuses telles que Gucci, Louis Vuitton, Chanel, Hermès, et Yves Saint Laurent. Chaque pièce incarne l\'essence du luxe et de l\'innovation, alliant savoir-faire artisanal et matériaux de qualité supérieure.'
        ];
