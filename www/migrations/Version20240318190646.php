 ...
 */
final class Version20240318190646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_image DROP reference_produit_id, DROP reference_article_id');
        $this->addSql('ALTER TABLE app_produit ADD image_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `app_image` ADD reference_produit_id INT DEFAULT NULL, ADD reference_article_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE `app_image` ADD CONSTRAINT FK_13EE8992268AB3D3 FOREIGN KEY (reference_article_id) REFERENCES app_article (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE `app_image` ADD CONSTRAINT FK_13EE89925B2A4BB4 FOREIGN KEY (reference_produit_id) REFERENCES app_produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE `app_produit` DROP image_id');
    }
}
